                    ...
                    <a href="/dq" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Design Qualification</h5>
                                <h3 class="card-title mb-2 text-center">{{ $dq }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/iq" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Instalation Qualification</h5>
                                <h3 class="card-title mb-2 text-center">{{ $iq }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/pq" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Performance Qualification</h5>
                                <h3 class="card-title mb-2 text-center">{{ $pq }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/pv" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Protocol Validation</h5>
                                <h3 class="card-title mb-2 text-center">{{ $pv }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/oq" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Operational Qualification</h5>
                                <h3 class="card-title mb-2 text-center">{{ $oq }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/rv" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Report Validation</h5>
                                <h3 class="card-title mb-2 text-center">{{ $rv }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/fat" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">FAT</h5>
                                <h3 class="card-title mb-2 text-center">{{ $fat }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/fr" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Usulan Perubahan</h5>
                                <h3 class="card-title mb-2 text-center">{{ $fr }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/ms" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Material Specifiation</h5>
                                <h3 class="card-title mb-2 text-center">{{ $ms }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/ps" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Packaging Specification</h5>
                                <h3 class="card-title mb-2 text-center">{{ $ps }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/qs" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Quality Statement</h5>
                                <h3 class="card-title mb-2 text-center">{{ $qs }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/st" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Stability Test</h5>
                                <h3 class="card-title mb-2 text-center">{{ $st }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="/sop" class="m-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center">Standard Operational Procedure</h5>
                                <h3 class="card-title mb-2 text-center">{{ $sop }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                   <img src=" /img/icons/dashboard/design.png" alt="chart success"
                                        class="rounded" />
                                </div>
                                <div class="dropdown">
                            ...
                            <h3 class="card-title mb-2">{{ $sop }}</h3>
